...
public class LoginPage extends SSPanel {
    ...
    public void action() {
        ...
        if(Login.login(email, password)) {
            SSWindow.notificationsPage.addNotifications("Accesso effettuato", "Bentornato " + Login.decode(Main.currentUser.name()) + "!");
            new Message("Accesso effettuato", "Bentornato " + Login.decode(Main.currentUser.name()) + "!", true);
